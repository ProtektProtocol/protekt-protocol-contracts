...
// admin
// 	Governance address can set governance
// 	Non-governance address can not set governance
// 	Governance address can set feeModel
...
//     When a user has several allocation to claim
//       ✓ Allows the user to claim multiple weeks at once (188325 gas)

//   Contract: MerkleRedeem
//     ✓ stores an allocation (80318 gas)
//     ✓ doesn't allow an allocation to be overwritten (105821 gas)
//     ✓ stores multiple allocations (80318 gas)
//     With a week finished
//       ✓ Reverts when the user attempts to claim before an allocation is produced (27089 gas)
//     When a user has an allocation to claim
//       ✓ Allows the user to claimWeek (82564 gas)
//       ✓ Doesn't allow a user to claim for another user (27089 gas)
//       ✓ Reverts when the user attempts to claim the wrong balance (27089 gas)
//       ✓ Reverts when the user attempts to claim twice (107619 gas)
//     When a user has several allocation to claim
//       ✓ Allows the user to claim once the time has past (150128 gas)
//       ✓ Allows the user to claim multiple weeks at once (110085 gas)
//       ✓ Returns an array of week claims (84020 gas)
//       ✓ Returns an array of merkle roots
