...
const uncapContract = async (contractAddress, contractABI, args, from, privateKey, web3, network) => {
  try{
...
(async function(){
  ...
  const contractAddress = "0x98b996F3e7DEAAcAF75E07822fFbe287059bFD1f"
  ...
  try{
    let result = uncapContract(contractAddress,ABI,[],PUBLIC_KEY,PRIVATE_KEY,web3,1)
    console.log(result)
  }catch(e){
    console.log(e)
  }
